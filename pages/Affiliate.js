        ...
        >
          ...
          <div className="mt-4 flex justify-center">
            {affiliate.link ? (
              ...
              >
                <span>{affiliate.buttonName}</span>
              </Link>
            ) : (
              <span className="rounded-full bg-blue-900 text-white text-sm font-semibold p-1 lg:py-2 lg:px-4 cursor-not-allowed">
                {affiliate.buttonName}
              </span>
            )}
          </div>
        </div>
